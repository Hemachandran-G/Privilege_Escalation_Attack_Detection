...
ROOT_URLCONF = 'privilege_escalation_attack_detection.urls'
...
WSGI_APPLICATION = 'privilege_escalation_attack_detection.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'privilege_escalation_attack_detection',
        'USER':'root',
        'PASSWORD': 'root',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
